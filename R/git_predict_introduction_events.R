...
f_predict_introduction_events_gmb <-function(outdata,brt_mod,species,temp_inc){
  require(gbm)
  require(stringr)
  require(dplyr)
  ...
  #data_no_pike$prob_introduction<-data_no_pike$prob_introduction #annual estimates based on total introductions in time period
